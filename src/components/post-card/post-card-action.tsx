...
export function PostCardAction({ icon: Icon, backgroundHover = "hover:bg-blue-100", iconClassName, textHover = "group-hover:text-blue-500", children, onClick }: PostCardActionProps) {
    return (
